...
Histogram of *absolute frequencies* of monthly credit card balance by the two classes no default or default on monthly credit card payments. It illustrates the distribution of monthly credit card balance by
the two classes no default or default on monthly credit card payments.
